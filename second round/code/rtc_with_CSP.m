...
oaclb10P7=OutputACL(vlosclaP7,vloscuaP7,acl14);
oacub10P7=OutputACU(vlosclaP7,vloscuaP7,acu14);
...
% losclNIP20=LeftOverSCL(sclNI,acu11);
% loscuNIP20=LeftOverSCU(scuNI,acl11);
% %leftover SC at R15 for f27
% oaclb15P4=OutputACL(losclNIP20,loscuNIP20,acl11);
% oacub15P4=OutputACU(losclNIP20,loscuNIP20,acu11);
...
% eqscl27=rtcminconv(losclNIP20,rtcminconv(loscla15P20,rtcminconv(loscla14P20,loscla10P20)));
% eqscu27=rtcminconv(loscuNIP20,rtcminconv(loscua15P20,rtcminconv(loscua14P20,loscua10P20)));
...
eqscu28=rtcminconv(vloscuP21,loscua11P21);
...
eqscl6=rtcminconv(losclNIP25,rtcminconv(sclRouter,rtcminconv(loscla11P25,rtcminconv(loscla10P25,sclRouter))));
...
vlosclP33=LeftOverSCL(vlosclaP7,acu14);
vloscuP33=LeftOverSCU(vloscuaP7,acl14);

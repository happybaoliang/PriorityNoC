...
concscl=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,scl),scl),scl),scl),linkl);
eqscl4f4=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,scl),scl),scl),scl),linkl);
while (f4_buf_r10>1) && (rtch(acu,eqscl4f4)<=Deadline(4))
    ...
    eqscl4f4=rtcminconv(rtcminconv(linkl,linkl),rtcminconv(concscl,temp(1)));
end
...
temp1=rtcmin(rtcplus(scl,f4_buf_r10),rtcplus(scl,f4_buf_r6));
temp2=rtcmin(rtcplus(scl,f4_buf_r7),rtcplus(scl,f4_buf_r8));
tau=rtcmatminclos(rtcmin(temp1,temp2),0,times);
disp(['final latency of f4: ',num2str(rtch(acu,rtcminconv(concscl,tau(1))))]);
disp(['Optimized Bufsize of f4: ',num2str(f4_buf_r8),' , ',num2str(f4_buf_r7),' , ',num2str(f4_buf_r6),' , ',num2str(f4_buf_r10)]);

partialscl4f4=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,taulr8f4(1)),scl),taulr7f4(1)),scl),taulr6f4(1)),scl),taulr10f4(1));
partialscu4f4=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linku,tauur8f4(1)),scu),tauur7f4(1)),scu),tauur6f4(1)),scu),tauur10f4(1));
...
concscl4f1=rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,scl),scl),scl),rtcminconv(leftscl4f1,linkl));
...
temp2=rtcmin(rtcplus(scl,f1_buf_r15),rtcplus(scl,f1_buf_r16));
tau=rtcmatminclos(rtcmin(temp1,temp2),0,times);
eqsc=rtcminconv(concscl4f1,tau(1));
disp(['final latency of f1: ',num2str(rtch(acu,eqsc))]);
...
partialsclf1=rtcminconv(rtcminconv(rtcminconv(linkl,taulr16f1(1)),scl),taulr15f1(1));
partialscuf1=rtcminconv(rtcminconv(rtcminconv(linku,tauur16f1(1)),scu),tauur15f1(1));
...
concscl4f2=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,leftscl4f2),scl),scl),scl),rtcminconv(scl,linkl));
...
temp1=rtcmin(rtcplus(scl,f2_buf_r5),rtcplus(scl,f2_buf_r9));
temp2=rtcmin(rtcplus(scl,f2_buf_r13),rtcplus(scl,f2_buf_r14));
tau=rtcmatminclos(rtcmin(rtcmin(temp1,temp2),rtcplus(leftscl4f2,f2_buf_r15)),0,times);
eqsc=rtcminconv(concscl4f2,tau(1));
disp(['final latency of f2: ',num2str(rtch(acu,eqsc))]);
...
partialscu4f2=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linku,tauur15f2(1)),leftscu4f2),tauur14f2(1)),scu),tauur13f2(1));
partialscl4f2=rtcminconv(rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,taulr15f2(1)),leftscl4f2),taulr14f2(1)),scl),taulr13f2(1));
...
concscl4f3=rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,leftscl134f3),leftscl94f3),scl),rtcminconv(scl,linkl));
eqscl4f3=rtcminconv(rtcminconv(rtcminconv(rtcminconv(linkl,leftscl134f3),leftscl94f3),scl),rtcminconv(scl,linkl));
...
temp1=rtcmin(rtcplus(scl,f3_buf_r1),rtcplus(scl,f3_buf_r5));
temp2=rtcmin(rtcplus(leftscl94f3,f3_buf_r9),rtcplus(leftscl134f3,f3_buf_r13));
tau=rtcmatminclos(rtcmin(temp1,temp2),0,times);
eqsc=rtcminconv(concscl4f3,tau(1));
disp(['final delay of f3: ',num2str(rtch(acu,eqsc))]);

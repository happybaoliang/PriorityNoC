...
On obtaining the equivalent service curve of flow controller for $f_j$ at router $R_i$ (denoted as $<\beta_{FC,R_i,f_j}^l,\beta_{FC,R_i,f_j}^u>$), we get the equivalent service curve of router $R_i$ after breaking the cyclic-dependence loop:
$$\beta_{R_i,f_j}^l=\beta_{BW}^l\otimes\beta_{RC}^l\otimes\beta_{VA}^l\otimes\beta_{SA}^l\otimes\beta_{ST,R_i,f_j}^l\otimes\beta_{FC,R_i,f_j}^l,$$
$$\beta_{R_i,f_j}^u=\beta_{BW}^u\otimes\beta_{RC}^u\otimes\beta_{VA}^u\otimes\beta_{SA}^u\otimes\beta_{ST,R_i,f_j}^u\otimes\beta_{FC,R_i,f_j}^u.$$

...
newvalue=f1_delay_r14+L(4)*ceil((L(1)+J(4)+indirect_jitter_to_f1)/T(4));
...
f4_delay_r10=L(4);
indirect_jitter_to_f4=0;
newvalue=f4_delay_r6+L(1)*ceil((L(4)+J(1)+indirect_jitter_to_f4)/T(1));
while(f4_delay_r10~=newvalue)
    f4_delay_r10=newvalue;
    newvalue=f4_delay_r6+L(1)*ceil((f4_delay_r10+J(1)+indirect_jitter_to_f4)/T(1));
end


%f2
f2_delay_r15=L(2);
indirect_jitter_to_f2=f4_delay_r10+J(4)+(4-1)-4;
newvalue=L(2)+ceil((L(2)+J(1)+indirect_jitter_to_f2)/T(1))*L(1);
...
newvalue=L(3)+ceil((L(3)+J(2)+indirect_jitter_to_f3)/T(2))*L(2);
while (f3_delay_r13~=newvalue)
    f3_delay_r13=newvalue;
    newvalue=L(3)+ceil((f3_delay_r13+J(2)+indirect_jitter_to_f3)/T(2))*L(2);
end
f3_delay_r9=L(3);
newvalue=f3_delay_r13+ceil((L(3)+J(2)+indirect_jitter_to_f3)/T(2))*L(2)-ceil((f3_delay_r13+J(2)+indirect_jitter_to_f3)/T(2))*L(2);
...
f1_buf_r10=min(L(1),ceil((f1_delay_r10+J(4)+indirect_jitter_to_f1)/T(4))*L(4)+1);

f4_buf_r8=min(L(4),1);
f4_buf_r7=min(L(4),1);
f4_buf_r6=min(L(4),1);
f4_buf_r10=min(L(4),ceil((f4_delay_r10+J(1)+indirect_jitter_to_f4)/T(1))*L(1)+1);
...
newvalue=ceil((f4_busy_period_r10+J(4))/T(4))*L(4)+ceil((f4_busy_period_r10+J(1))/T(1))*L(1);
while(f4_busy_period_r10~=newvalue)
    f4_busy_period_r10=newvalue;
    newvalue=ceil((f4_busy_period_r10+J(4))/T(4))*L(4)+ceil((f4_busy_period_r10+J(1))/T(1))*L(1);
end
f4_num_pkt_r10=ceil((f4_busy_period_r10+J(4))/T(4));
f4_buf_r10=min(f4_num_pkt_r10*L(4),ceil((f4_busy_period_r10+J(1))/T(1))*L(1)+1);

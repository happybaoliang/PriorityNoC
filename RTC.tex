...
\begin{figure*}
  \centering
  \subfloat[]{\includegraphics[scale=0.4]{figures/LPKT.pdf}\label{lpkt}}\hspace{10pt}
  \subfloat[]{\includegraphics[scale=0.4]{figures/AC.pdf}\label{perio}}\hspace{10pt}
  \subfloat[]{\includegraphics[scale=0.4]{figures/BW_ST_SA.pdf}\label{result1}}
...
\begin{figure}
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[scale=0.6]{figures/rtcvssim.pdf}\\
